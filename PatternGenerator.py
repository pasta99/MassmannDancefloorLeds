...
class PatternGeneratorBase:
    ...
    def beat(self, bpm):
        ...
        self.beat_cycle += 1 
        self.beat_cycle %= self.beat_activation
...
class PatternGeneratorBeams(PatternGeneratorBase): 
    ...
    def beat_trigger(self, next_beat_time):
        ...
        self.beam_step_size = 80 / n_steps
        print(self.beam_step_size)
    ...
    def next_frame(self, dt):
        ...
        for i in range(len(self.beams)):
            for j in range(len(self.beams[i])):
                ...
                self.beams[i][j].advance(self.beam_step_size)
